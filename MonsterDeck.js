const BRONZE_UNITS_MONSTERS = [
  ...
  { name: 'Sigbin Stalker', type: 'Unit', faction: 'monsters', cost: 2, row: 'ranged', atk: 2, hp: 3, maxHp: 3 },
  ...
  { name: 'Minokawa Titan', type: 'Unit', faction: 'monsters', cost: 5, row: 'melee', atk: 6, hp: 6, maxHp: 6 },
  ...
  { name: 'Apoy ni Santelmo', type: 'Unit', faction: 'monsters', cost: 5, row: 'melee', atk: 6, hp: 3, maxHp: 3 },
];

const GOLD_UNITS_MONSTERS = [
  { name: 'Siyokoy', type: 'Unit', faction: 'monsters', cost: 6, row: 'ranged', atk: 7, hp: 5, maxHp: 5 },
  { name: 'Kataw Warlord', type: 'Unit', faction: 'monsters', cost: 7, row: 'melee', atk: 7, hp: 5, maxHp: 5 },
  { name: 'Pugot', type: 'Unit', faction: 'monsters', cost: 6, row: 'ranged', atk: 6, hp: 6, maxHp: 6 },
  { name: 'Busaw Giant', type: 'Unit', faction: 'monsters', cost: 8, row: 'melee', atk: 8, hp: 6, maxHp: 6 },
  ...
  { name: 'Ikugan Maw', type: 'Unit', faction: 'monsters', cost: 7, row: 'melee', atk: 7, hp: 6, maxHp: 6 },
];
